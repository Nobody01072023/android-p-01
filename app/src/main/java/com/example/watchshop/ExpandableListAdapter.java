...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<String> groupList; // List of genres
    private HashMap<String, List<String>> childMap; // Map of books for each genre
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView groupTextView = convertView.findViewById(R.id.listGroupTextView);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView childTextView = convertView.findViewById(R.id.listItemTextView);
